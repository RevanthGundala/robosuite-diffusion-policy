...
class RobomimicDataset(Dataset):
    ...
    def _compute_stats(self):
        ...
        # Use minimum std of 0.01 to prevent division by zero while preserving variation
        # Note: 0.1 was too aggressive and compressed Lift's observations (which have std ~0.01-0.04)
